...
<main class="report-container">
    ...
    <!-- INTRO: GANTT CHART AND PLANNING -->
    <section class="report-section" id="chapitre-0">
        ...
        <article class="section-content">
            ...
            <!-- FIGURE PLACEHOLDER: GANTT CHART -->
    ...
    <!-- CHAPITRE 1: LAMPP, MARIADB & RECUP.SH -->
    <section class="report-section" id="chapitre-1">
        ...
        <article class="section-content">
            ...
            <!-- FIGURE PLACEHOLDER: DATABASE SCHEMA -->
    ...
    <section class="report-section" id="chapitre-2">
        ...
        <article class="section-content">
            ...
            <div class="step-block">
                <h3 class="step-title">2.1 Orchestration et traitement des données avec Node-RED</h3>
                <p class="content-paragraph">
                    Pour faire le pont entre notre réseau de capteurs et la base de données, nous avons déployé Node-RED, un puissant outil de programmation visuelle agissant comme un Middleware (intergiciel). Fonctionnant sur le port réseau 1880, ce service a été configuré pour s'exécuter en tâche de fond de manière persistante, résistant aux déconnexions du terminal. Notre chaîne de traitement (Flow) sous Node-RED a été construite pour interagir directement avec le broker MQTT (Mosquitto). L'outil s'abonne en temps réel aux canaux (Topics) sur lesquels les 4 capteurs du campus publient leurs mesures de température et d'humidité. Lorsqu'une trame est interceptée, Node-RED extrait la charge utile (Payload), analyse la structure des données (parsing JSON ou extraction de chaînes), et formate ces valeurs pour les rendre compatibles avec nos requêtes d'insertion SQL vers MariaDB. Cette architecture garantit un découplage parfait entre la couche matérielle (les capteurs) et la couche de stockage.
                </p>
            </div>

            <!-- FIGURE PLACEHOLDER: NODE-RED FLOW -->
    ...
    <!-- CHAPITRE 3: DÉVELOPPEMENT WEB DYNAMIQUE -->
